...
namespace Apollo.WebApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            var user = await _service.FindAsync(new UserLoginInfo(externalLogin.LoginProvider, externalLogin.ProviderKey));
        ...
        public async Task<IHttpActionResult> RegisterExternal(RegisterExternalBindingModel model)
        {
            ...
            var user = await _service.FindAsync(new UserLoginInfo(model.Provider, verifiedAccessToken.user_id));
        ...
        public async Task<IHttpActionResult> ObtainLocalAccessToken(string provider, string externalAccessToken)
        {
            ...
            var user = await _service.FindAsync(new UserLoginInfo(provider, verifiedAccessToken.user_id));
